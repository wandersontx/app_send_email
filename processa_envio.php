<?php
	...
	require "../../app_send_mail/bibliotecas/PHPMailer/POP3.php";//protocolo de recebimento de e-mail
	require "../../app_send_mail/bibliotecas/PHPMailer/SMTP.php";//protocolo de envio de e-mail
